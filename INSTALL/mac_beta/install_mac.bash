...
function install_conda () {
	...
	if [ $(uname -m) == 'x86_64' ]; then
		wget 'https://repo.anaconda.com/miniconda/Miniconda3-latest-MacOSX-x86_64.sh' -O $CONDAEXE
    else
        wget 'https://repo.anaconda.com/miniconda/Miniconda3-latest-MacOSX-x86.sh' -O $CONDAEXE
    fi; exit_if_error
